...
import com.example.user.codechef.activities.ItemInfoActivity;
...
public class ApprovedItemListAdapter extends RecyclerView.Adapter<ApprovedItemListAdapter.ApprovedItemListHolder> {
    ...
    public void onBindViewHolder(ApprovedItemListHolder holder, int position) {
        ...
        if(holder.availableStatus) {
            holder.itemAvailableStatusTv.setText("Yes");
        } else {
            holder.itemAvailableStatusTv.setText("No");
        }
    }
    ...
    public class ApprovedItemListHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.approved_item_available_status_tv)
        TextView itemAvailableStatusTv;
        ...
        @BindView(R.id.approved_item_layout)
